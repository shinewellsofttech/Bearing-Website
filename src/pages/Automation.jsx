...
function Automation() {
  ...
  const htmlContent = `
        ...
        <!-- banner area start -->
        <section class="rs-banner-area rs-banner-thirteen p-relative rs-swiper">
        ...
        <!-- about area start -->
        <section class="rs-about-area rs-about-fourteen section-space-bottom">
        ...
        <!-- services area start -->
        <section class="rs-services-area rs-services-eleven p-relative">
            <div class="container has-large">
                <div class="row">
                    <div class="col-lg-12">
        ...
        <!-- blog area start -->
        <section class="rs-blog-area section-space rs-blog-one has-theme-cyan">
            <div class="container has-large">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="rs-section-subtitle-wrapper">
        ...
        <!-- cta area start -->
        <section class="rs-cta-area rs-cta-three has-theme-cyan">
            <div class="container has-large">
