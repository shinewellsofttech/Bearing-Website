...
function ManufacturingOnePage() {
  ...
  const htmlContent = `
        ...
        <!-- banner area start -->
        <section id="home" class="rs-banner-area rs-banner-twelve rs-swiper">
            <div class="rs-banner-slider-wrapper">
                <div class="swiper" data-clone-slides="false" data-loop="true" data-speed="2000" data-autoplay="true"
                    ...
                    <div class="swiper-wrapper process-counts">
                        <div class="swiper-slide">
                            <div class="rs-banner-item-wrapper">
                                <div class="rs-banner-bg-thumb" data-background="assets/images/bg/banner-bg-20.png">
                                </div>
                                <div class="container">
                                    <div class="row g-5">
                                        <div class="col-xl-9 col-lg-10">
                                            <div class="rs-banner-item">
                                                <div class="rs-banner-content">
                                                    <span class="rs-banner-stroke-text">2025</span>
                                                    <h1 class="rs-banner-title">Manufacture</h1>
                                                    <div class="rs-banner-descrip">
                                                        <p>Indignation and dislike men who are beguiled and demoralized
                                                            by the charms
                                                            of pleasure of the moment. </p>
                                                    </div>
                                                    <div class="rs-banner-btn">
                                                        <a class="rs-btn has-theme-light-green has-icon has-bg"
                                                            href="contact.html">Discover More
                                                            <span class="icon-box">
                        ...
                        <div class="swiper-slide">
                            <div class="rs-banner-item-wrapper">
                                <div class="rs-banner-bg-thumb" data-background="assets/images/bg/banner-bg-21.png">
                                </div>
                                <div class="container">
                                    <div class="row g-5">
                                        <div class="col-xl-9 col-lg-10">
                    ...
                    <div class="rs-banner-navigation">
                        <button class="swiper-button-prev rs-swiper-btn has-theme-light-green"><i
                                class="fa-regular fa-arrow-left"></i></button>
                        <button class="swiper-button-next rs-swiper-btn has-theme-light-green"><i
        ...
        <section id="homeservices"
            class="rs-services-area section-space-top rs-services-one p-relative has-theme-green">
                ...
                <div class="row  g-5 section-title-space align-items-center">
                    <div class="col-xl-7 col-lg-7">
                        <div class="rs-section-title-wrapper">
                            ...
                            <h2 class="rs-section-title rs-split-text-enable split-in-fade has-theme-green">Creative
                                features from production industry</h2>
                        </div>
                    </div>
                    <div class="col-xl-5 col-lg-5">
                        <div class="rs-services-btn">
                            <a class="rs-btn has-theme-light-green has-icon has-bg" href="services.html">View All
                                Solution
                                <span class="icon-box">
                            ...
                            <ul class="nav nav-pills" id="pills-tab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="pills-item-one-tab" data-bs-toggle="pill"
                                        ...
                                        Industrial Construction <span class="rs-services-icon"><svg
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-item-two-tab" data-bs-toggle="pill"
                                        ...
                                        aria-controls="pills-item-two" aria-selected="false"> High regulation industry
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-item-three-tab" data-bs-toggle="pill"
                                        ...
                                        Bridge Construction<span class="rs-services-icon"><svg
                                                xmlns="http://www.w3.org/2000/svg" width="18" height="12"
                                                viewBox="0 0 18 12" fill="none">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    d="M0 6C0 5.66249 0.273604 5.38889 0.611111 5.38889L15.0246 5.38889L11.179 1.54323C10.9403 1.30458 10.9403 0.917645 11.179 0.678991C11.4176 0.440337 11.8046 0.440337 12.0432 0.678991L16.9321 5.56788C17.1708 5.80653 17.1708 6.19347 16.9321 6.43212L12.0432 11.321C11.8046 11.5597 11.4176 11.5597 11.179 11.321C10.9403 11.0824 10.9403 10.6954 11.179 10.4568L15.0246 6.61111L0.611111 6.61111C0.273604 6.61111 0 6.33751 0 6Z"
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-item-four-tab" data-bs-toggle="pill"
                                        ...
                                        Oil &amp; Gas Energy<span class="rs-services-icon"><svg
                                                xmlns="http://www.w3.org/2000/svg" width="18" height="12"
                                                viewBox="0 0 18 12" fill="none">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    d="M0 6C0 5.66249 0.273604 5.38889 0.611111 5.38889L15.0246 5.38889L11.179 1.54323C10.9403 1.30458 10.9403 0.917645 11.179 0.678991C11.4176 0.440337 11.8046 0.440337 12.0432 0.678991L16.9321 5.56788C17.1708 5.80653 17.1708 6.19347 16.9321 6.43212L12.0432 11.321C11.8046 11.5597 11.4176 11.5597 11.179 11.321C10.9403 11.0824 10.9403 10.6954 11.179 10.4568L15.0246 6.61111L0.611111 6.61111C0.273604 6.61111 0 6.33751 0 6Z"
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-item-five-tab" data-bs-toggle="pill"
                                        ...
                                        Mechanical Engineering<span class="rs-services-icon"><svg
                                                xmlns="http://www.w3.org/2000/svg" width="18" height="12"
                                                viewBox="0 0 18 12" fill="none">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    d="M0 6C0 5.66249 0.273604 5.38889 0.611111 5.38889L15.0246 5.38889L11.179 1.54323C10.9403 1.30458 10.9403 0.917645 11.179 0.678991C11.4176 0.440337 11.8046 0.440337 12.0432 0.678991L16.9321 5.56788C17.1708 5.80653 17.1708 6.19347 16.9321 6.43212L12.0432 11.321C11.8046 11.5597 11.4176 11.5597 11.179 11.321C10.9403 11.0824 10.9403 10.6954 11.179 10.4568L15.0246 6.61111L0.611111 6.61111C0.273604 6.61111 0 6.33751 0 6Z"
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-item-six-tab" data-bs-toggle="pill"
                                        ...
                                        Automation Industry<span class="rs-services-icon"><svg
                                                xmlns="http://www.w3.org/2000/svg" width="18" height="12"
                                                viewBox="0 0 18 12" fill="none">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    d="M0 6C0 5.66249 0.273604 5.38889 0.611111 5.38889L15.0246 5.38889L11.179 1.54323C10.9403 1.30458 10.9403 0.917645 11.179 0.678991C11.4176 0.440337 11.8046 0.440337 12.0432 0.678991L16.9321 5.56788C17.1708 5.80653 17.1708 6.19347 16.9321 6.43212L12.0432 11.321C11.8046 11.5597 11.4176 11.5597 11.179 11.321C10.9403 11.0824 10.9403 10.6954 11.179 10.4568L15.0246 6.61111L0.611111 6.61111C0.273604 6.61111 0 6.33751 0 6Z"
                                        ...
                                        <div class="row g-5 align-items-center">
                                            ...
                                            <div class="col-xl-6 col-lg-6">
                                                <div class="rs-services-tab-content">
                                                    <h3 class="rs-services-tab-title  has-theme-green">We solve
                                                        worldwide industrial every problem</h3>
                                                    <p>The industryâ€™s standard dummy text ever since the 1500s, when an
                                                        unknown
                                                    ...
                                                    <div class="rs-services-tab-btn">
                                                        <a class="rs-btn has-text has-theme-green has-icon"
                                                            href="services-details.html">Read More
                                                            <span class="icon-box">
                                                                <svg class="icon-first"
                                                                    xmlns="http://www.w3.org/2000/svg"
                                                                    viewBox="0 0 32 32">
                                ...
                                <div class="tab-pane fade" id="pills-item-two" role="tabpanel"
                                    ...
                                    <div class="rs-services-tab-content-wrapper p-relative">
                                        <div class="row g-5 align-items-center">
                                            ...
                                            <div class="col-xl-6 col-lg-6">
                                                <div class="rs-services-tab-content">
                                                    <h3 class="rs-services-tab-title  has-theme-green">A high regulation
                                                        industry
                                                        refers </h3>
                                                    <p>The industryâ€™s standard dummy text ever since the 1500s, when an
                                                        unknown
                                ...
                                <div class="tab-pane fade" id="pills-item-three" role="tabpanel"
                                    ...
                                    <div class="rs-services-tab-content-wrapper p-relative">
                                        <div class="row g-5 align-items-center">
                                            ...
                                            <div class="col-xl-6 col-lg-6">
                                                <div class="rs-services-tab-content">
                                                    <h3 class="rs-services-tab-title  has-theme-green">Bridge
                                                        construction is a
                                                        complex engineering
                                                    </h3>
                                                    <p>The industryâ€™s standard dummy text ever since the 1500s, when an
                                ...
                                <div class="tab-pane fade" id="pills-item-four" role="tabpanel"
                                    ...
                                    <div class="rs-services-tab-content-wrapper p-relative">
                                        <div class="row g-5 align-items-center">
                                            ...
                                            <div class="col-xl-6 col-lg-6">
                                                <div class="rs-services-tab-content">
                                                    <h3 class="rs-services-tab-title  has-theme-green">The oil and gas
                                                        energy sector
                                                        is a crucial
                                                    </h3>
                                                    <p>The industryâ€™s standard dummy text ever since the 1500s, when an
                                ...
                                <div class="tab-pane fade" id="pills-item-five" role="tabpanel"
                                    ...
                                    <div class="rs-services-tab-content-wrapper p-relative">
                                        <div class="row g-5 align-items-center">
                                            ...
                                            <div class="col-xl-6 col-lg-6">
                                                <div class="rs-services-tab-content">
                                                    <h3 class="rs-services-tab-title  has-theme-green">Mechanical
                                                        engineering is a
                                                        broad field</h3>
                                                    <p>The industryâ€™s standard dummy text ever since the 1500s, when an
                                                        unknown
                                ...
                                <div class="tab-pane fade" id="pills-item-six" role="tabpanel"
                                    ...
                                    <div class="rs-services-tab-content-wrapper p-relative">
                                        <div class="row g-5 align-items-center">
                                            ...
                                            <div class="col-xl-6 col-lg-6">
                                                <div class="rs-services-tab-content">
                                                    <h3 class="rs-services-tab-title  has-theme-green">The automation
                                                        industry
                                                        involves the
                                                        application</h3>
                                                    <p>The industryâ€™s standard dummy text ever since the 1500s, when an
        ...
        <section class="rs-work-step-area rs-work-step-four section-space-bottom">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="rs-text-slide">
                            <div class="swiper rs-marquee-slide">
                    ...
                    <div class="row g-5 process-counts">
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="rs-work-step-item wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                                <h5 class="rs-work-step-title">Preparation of project documents</h5>
                                <div class="rs-work-step-descrip">
                                    <p> Page when looking at its layout. The point of using Lorem Ipsum is that it has a
                                        more-less normal distribution.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="rs-work-step-item active wow fadeInUp" data-wow-delay=".5s"
                                data-wow-duration="1s">
                                <h5 class="rs-work-step-title">Creation of a project with a team on time</h5>
                                <div class="rs-work-step-descrip">
                                    <p> At the heart of the global landscape, the industry stands as a multidimensional
                                        for
                                        everting progress driving. </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="rs-work-step-item wow fadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                                <h5 class="rs-work-step-title"> Completion of the project and payment</h5>
                                <div class="rs-work-step-descrip">
                                    <p> That they cannot foresee the pain and trouble that are bound to ensue, and equal
                                        blame
                                        belongs to those. </p>
                                </div>
                            </div>
        ...
        <!-- about area start -->
        <section id="homeabout" class="rs-about-area section-space-bottom rs-about-eight has-theme-green">
            <div class="container">
                <div class="row g-5">
                    <div class="col-xl-6 col-lg-5">
                        <div class="rs-about-thumb-wrapper">
                            <div class="rs-about-shape-one">
                                <img src="assets/images/shape/circle-shape-two.png" alt="image">
                            </div>
                            <div class="rs-about-shape-two">
                                <img src="assets/images/shape/line-shape.png" alt="image">
                            </div>
                            <div class="rs-about-thumb img-one">
                                <img src="assets/images/about/about-thumb-16.png" alt="image">
                            </div>
                            <div class="rs-about-thumb img-two">
                                <img src="assets/images/about/about-thumb-17.png" alt="image">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="rs-about-wrapper">
                            <div class="rs-about-content-wrapper">
                                <div class="rs-section-title-wrapper">
                                    ...
                                    <h2 class="rs-section-title has-theme-green rs-split-text-enable split-in-fade">We
                                        largest
                                        independent
                                        manufacturing</h2>
                                    <p class="descrip">We solve worldwide industrial every problem, the heart of global
                                        landscape
                                        the industry stands multidimensional was progress driving more-or-less normal
                                        distribution.</p>
                                </div>
        ...
        <section id="homeportfolio" class="rs-portfolio-area rs-portfolio-eight rs-swiper">
                ...
                <div class="row g-5 justify-content-center">
                    <div class="col-xxl-6 col-xl-8 col-lg-7 col-md-8">
                        <div class="rs-section-title-wrapper text-center section-title-space">
                            ...
                            <h2 class="rs-section-title has-theme-green rs-split-text-enable split-in-fade">Recently
                                Complete
                                Project</h2>
                        </div>
                    </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="rs-portfolio-item">
                                            ...
                                            <div class="rs-portfolio-btn">
                                                <a class="rs-btn has-theme-light-green has-circle has-icon"
        ...
        <section class="rs-why-choose-area section-space rs-why-choose-one has-theme-green">
            <div class="rs-why-choose-bg-thumb" data-background="assets/images/bg/contact-bg-09.png"></div>
            <div class="rs-why-choose-shape-one">
                <img src="assets/images/shape/circle-shape-three.png" alt="image">
            </div>
            <div class="container">
                <div class="row g-5">
                    <div class="col-xl-7 col-lg-7">
                        <div class="rs-why-choose-content-wrapper">
                                    ...
                                    <div class="rs-why-choose-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="52" height="39"
                                            ...
                                            <path
                                                ...
                                                stroke="#507A7C" stroke-width="1.7" stroke-miterlimit="10"
                                            ...
                                            <path
                                                ...
                                                stroke="#507A7C" stroke-width="1.7" stroke-miterlimit="10"
                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M18.4194 35.0323H1V1H51V35.0323H33.5806" stroke="#507A7C"
                                            ...
                                            <path
                                                ...
                                                stroke="#507A7C" stroke-width="1.7" stroke-miterlimit="10"
                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M10.2754 9.95117H41.727" stroke="#507A7C" stroke-width="1.7"
                                                stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round">
                                            </path>
                                            <path d="M41.7259 12.8535H32.3711" stroke="#507A7C" stroke-width="1.7"
                                                stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round">
                                            </path>
                                            <path d="M19.6302 12.8535H10.2754" stroke="#507A7C" stroke-width="1.7"
                                                stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round">
                                            </path>
                                            <path d="M39.0663 15.8379H35.1953" stroke="#507A7C" stroke-width="1.7"
                                                stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round">
                                            </path>
                                            <path d="M16.8065 15.8379H12.9355" stroke="#507A7C" stroke-width="1.7"
                                                stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round">
                                            </path>
                                        </svg>
                                    </div>
                                    ...
                                    <div class="rs-why-choose-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="52" height="44"
                                            ...
                                            <path
                                                ...
                                                stroke="#507A7C" stroke-width="2"></path>
                                        </svg>
                                    </div>
                                    <div class="rs-why-choose-content">
                                        <h5 class="rs-why-choose-title">We're Certified Company</h5>
                            ...
                            <div class="rs-why-choose-btn">
                                <a class="rs-btn has-theme-light-green has-icon has-bg" href="pricing.html">See Our
                                    Pricing Plan
                                    <span class="icon-box">
                                        <svg class="icon-first" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                                            <path
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-12">
                                        <div class="rs-contact-btn">
                                            <button type="submit" class="rs-btn has-theme-light-green">Send
                                                Message</button>
                                        </div>
                                    </div>
                                </div>
        ...
        <section class="rs-testimonial-area section-space rs-testimonial-five rs-swiper has-theme-green primary-bg">
            <div class="rs-testimonial-bg-thumb" data-background="assets/images/bg/testimonials-bg-05.png"></div>
            <div class="container">
                <div class="row g-5">
                    <div class="col-xl-4 col-lg-4">
                        <div class="rs-testimonial-section-wrapper">
                            ...
                            <div class="rs-testimonial-text-btn">
                                <a href="contact.html">View all testimonial</a>
                            </div>
                        </div>
                    </div>
        ...
        <!-- team area start -->
        <section class="rs-team-area section-space rs-team-one has-theme-green">
            <div class="container">
                <div class="row  g-5 section-title-space align-items-center">
                    <div class="col-xl-7 col-lg-7">
                        <div class="rs-section-title-wrapper">
                    ...
                    <div class="col-xl-5 col-lg-5">
                        <div class="rs-team-btn">
                            <a class="rs-btn has-theme-light-green has-icon has-bg" href="team.html">Become a Member
                                <span class="icon-box">
                                    <svg class="icon-first" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                                        <path
                                            d="M31.71,15.29l-10-10L20.29,6.71,28.59,15H0v2H28.59l-8.29,8.29,1.41,1.41,10-10A1,1,0,0,0,31.71,15.29Z">
        ...
        <!-- counter area start -->
        <div class="rs-counter-area rs-counter-one section-space-bottom p-relative has-theme-green">
            <div class="container">
                <div class="row g-5">
                ...
                <div class="row justify-content-center align-items-center">
                    <div class="col-xl-8 col-lg-9">
                        <div class="rs-section-title-wrapper text-center section-title-space">
                            ...
                            <h2 class="rs-section-title rs-split-text-enable split-in-fade has-theme-green">News and
                                Article
                            </h2>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="rs-blog-item wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                            ...
                            <div class="rs-blog-content">
                                ...
                                <h5 class="rs-blog-title"> <a href="blog-details.html">Construction of a
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="rs-blog-item wow fadeInUp" data-wow-delay=".5s" data-wow-duration="1s">
                            ...
                            <div class="rs-blog-content">
                                ...
                                <h5 class="rs-blog-title"> <a href="blog-details.html">Building
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="rs-blog-item wow fadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                            ...
                            <div class="rs-blog-content">
                                ...
                                <h5 class="rs-blog-title"> <a href="blog-details.html"> Interactive
        ...
        <div class="rs-brand-thumb-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="rs-brand-item">
                                                ...
                                                <div class="rs-brand-thumb">
                                                    <img src="assets/images/brand/brand-thumb-29.png" alt="image">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="rs-brand-item">
                                                <span class="rs-brand-shape"></span>
                                                <div class="rs-brand-thumb">
                                                    <img src="assets/images/brand/brand-thumb-30.png" alt="image">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="rs-brand-item">
                                                <span class="rs-brand-shape"></span>
                                                <div class="rs-brand-thumb">
                                                    <img src="assets/images/brand/brand-thumb-31.png" alt="image">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="rs-brand-item">
                                                <span class="rs-brand-shape"></span>
                                                <div class="rs-brand-thumb">
                                                    <img src="assets/images/brand/brand-thumb-32.png" alt="image">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="rs-brand-item">
                                                <span class="rs-brand-shape"></span>
                                                <div class="rs-brand-thumb">
                                                    <img src="assets/images/brand/brand-thumb-33.png" alt="image">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="rs-brand-item">
                                                <span class="rs-brand-shape"></span>
                                                <div class="rs-brand-thumb">
                                                    <img src="assets/images/brand/brand-thumb-34.png" alt="image">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <!-- cta area start -->
            <section id="homecontact" class="rs-cta-area rs-cta-two has-theme-green-two">
                <div class="container">
...
export default ManufacturingOnePage
