...
function AutomationOnePage() {
  ...
  const htmlContent = `
        ...
        <!-- banner area start -->
        <section id="home" class="rs-banner-area rs-banner-thirteen p-relative rs-swiper">
            <div class="rs-banner-shape">
                <img src="assets/images/shape/robo-arm-04.png" alt="image">
            </div>
            <div class="rs-banner-slider-wrapper">
                <div class="swiper" data-clone-slides="false" data-loop="true" data-speed="2000" data-autoplay="true"
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="rs-banner-item-wrapper">
                                        ...
                                        <div class="col-xxl-5 col-xl-6 col-lg-7">
                                            <div class="rs-banner-item">
                                                <div class="rs-banner-content">
                                                    ...
                                                    <h1 class="rs-banner-title">Unlocking Potential of Industry 4.0
                                                    </h1>
                                                    <div class="rs-banner-descrip">
                                                        <p>Our vans are fitted with high pressure jetting units which
                                                            will clear blocked drain safely and working roofio Ltd.</p>
                                                    </div>
                                                    <div class="rs-banner-btn-wrapper">
                                                        <div class="rs-banner-btn">
                                                            <a class="rs-btn has-theme-cyan has-icon has-bg white-bg is-uppercase height-55 is-ff-secondary fw-4"
                                                ...
                                                <div class="rs-banner-award-wrapper">
                                                    <div class="rs-banner-award-inner">
                                                        <div class="rs-banner-award-icon">
                                                            <img src="assets/images/award/award-09.png" alt="image">
                                                        </div>
                                                        <p class="rs-banner-award-title">We're Award Winning Company</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="rs-banner-bg-thumb" data-background="assets/images/bg/banner-bg-22.png">
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="rs-banner-item-wrapper">
                                        ...
                                        <div class="col-xxl-5 col-xl-6 col-lg-7">
                                            <div class="rs-banner-item">
                                                <div class="rs-banner-content">
                                                    ...
                                                    <h1 class="rs-banner-title">Powering The Future With Automation
                                                    </h1>
                                                    <div class="rs-banner-descrip">
                                                        <p>Our vans are fitted with high pressure jetting units which
                                                            will clear blocked drain safely and working roofio Ltd.</p>
                                ...
                                <div class="rs-banner-bg-thumb" data-background="assets/images/bg/banner-bg-23.png">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="rs-banner-pagination">
                        <div class="swiper-pagination rs-pagination has-theme-cyan"></div>
                    </div>
                </div>
            </div>
        </section>
        ...
        <!-- feature area start -->
        <section class="rs-feature-area rs-feature-five section-space has-theme-cyan">
            <div class="container has-large">
                <div class="row g-5">
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="rs-feature-item wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                            <div class="rs-feature-bg-thumb" data-background="assets/images/bg/features-bg-02.png">
                            </div>
                            ...
                            <div class="rs-feature-descrip">
                                <p>Industry's standard dummy text ever since the when an printer took a galley of type
                                    and
                                    scrambled</p>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="rs-feature-item wow fadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                            ...
                            <div class="rs-feature-descrip">
                                <p>Literature from 45 BC, making it over 2000 years old. Latin professor at
                                    Hampden-Sydney
        ...
        <!-- about area start -->
        <section id="homeabout" class="rs-about-area rs-about-fourteen section-space-bottom">
            <div class="rs-about-shape-one">
                <img src="assets/images/shape/about-shape-01.png" alt="image">
            </div>
            <div class="rs-about-shape-two">
                <img src="assets/images/shape/about-shape-08.png" alt="image">
            </div>
            <div class="container has-large">
                <div class="row">
                    <div class="col-xl-12">
                        <h2 class="rs-about-title">About Western Bearning</h2>
                    </div>
                </div>
                <div class="row g-5">
                    <div class="col-xl-12">
                        <div class="rs-about-wrapper">
                            ...
                            <div class="rs-about-content-wrapper">
                                <div class="rs-section-title-wrapper">
                                    <span class="rs-section-subtitle has-theme-cyan justify-content-start">
                                    ...
                                    <h2
                                        ...
                                        the most <span class="rs-theme-cyan">powerful facilities</span> in the
                                        world. Those
                                        that change automation industry</h2>
                                </div>
                                ...
                                <div class="rs-about-btn">
                                    <a class="rs-btn has-theme-cyan has-icon has-bg" href="about.html">Discover Us
                                        <span class="icon-box">
        ...
        <!-- services area start -->
        <section id="homeservices" class="rs-services-area rs-services-eleven p-relative">
            <div class="container has-large">
                <div class="row">
                    <div class="col-lg-12">
                ...
                <div class="row  g-5 section-title-space align-items-center">
                    <div class="col-xl-6 col-lg-6 col-md-7">
                        <div class="rs-section-title-wrapper">
                            <h2 class="rs-section-title has-theme-light-blue rs-split-text-enable split-in-fade">
                                Creative
                                features form automation industry </h2>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-5">
                        <div class="rs-services-btn">
                            <a class="rs-btn has-theme-cyan has-icon has-bg" href="services.html">More Services
                                <span class="icon-box">
                                ...
                                <ul class="nav nav-pills" id="pills-tab" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="pills-item-five-tab" data-bs-toggle="pill"
                                            ...
                                            aria-controls="pills-item-five" aria-selected="false">Process Automation
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="pills-item-six-tab" data-bs-toggle="pill"
                                            ...
                                            Robotics Integration<span class="rs-services-icon"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="18" height="12"
                                                    viewBox="0 0 18 12" fill="none">
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                                        d="M0 6C0 5.66249 0.273604 5.38889 0.611111 5.38889L15.0246 5.38889L11.179 1.54323C10.9403 1.30458 10.9403 0.917645 11.179 0.678991C11.4176 0.440337 11.8046 0.440337 12.0432 0.678991L16.9321 5.56788C17.1708 5.80653 17.1708 6.19347 16.9321 6.43212L12.0432 11.321C11.8046 11.5597 11.4176 11.5597 11.179 11.321C10.9403 11.0824 10.9403 10.6954 11.179 10.4568L15.0246 6.61111L0.611111 6.61111C0.273604 6.61111 0 6.33751 0 6Z"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="pills-item-seven-tab" data-bs-toggle="pill"
                                            ...
                                            Instruments<span class="rs-services-icon"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="18" height="12"
                                                    viewBox="0 0 18 12" fill="none">
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                                        d="M0 6C0 5.66249 0.273604 5.38889 0.611111 5.38889L15.0246 5.38889L11.179 1.54323C10.9403 1.30458 10.9403 0.917645 11.179 0.678991C11.4176 0.440337 11.8046 0.440337 12.0432 0.678991L16.9321 5.56788C17.1708 5.80653 17.1708 6.19347 16.9321 6.43212L12.0432 11.321C11.8046 11.5597 11.4176 11.5597 11.179 11.321C10.9403 11.0824 10.9403 10.6954 11.179 10.4568L15.0246 6.61111L0.611111 6.61111C0.273604 6.61111 0 6.33751 0 6Z"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="pills-item-eight-tab" data-bs-toggle="pill"
                                            ...
                                            Monitoring Systems<span class="rs-services-icon"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="18" height="12"
                                                    viewBox="0 0 18 12" fill="none">
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                                        d="M0 6C0 5.66249 0.273604 5.38889 0.611111 5.38889L15.0246 5.38889L11.179 1.54323C10.9403 1.30458 10.9403 0.917645 11.179 0.678991C11.4176 0.440337 11.8046 0.440337 12.0432 0.678991L16.9321 5.56788C17.1708 5.80653 17.1708 6.19347 16.9321 6.43212L12.0432 11.321C11.8046 11.5597 11.4176 11.5597 11.179 11.321C10.9403 11.0824 10.9403 10.6954 11.179 10.4568L15.0246 6.61111L0.611111 6.61111C0.273604 6.61111 0 6.33751 0 6Z"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="pills-item-nine-tab" data-bs-toggle="pill"
                                            ...
                                            aria-controls="pills-item-nine" aria-selected="false">
                                            Custom Automation<span class="rs-services-icon"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="18" height="12"
                                                    viewBox="0 0 18 12" fill="none">
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                                        d="M0 6C0 5.66249 0.273604 5.38889 0.611111 5.38889L15.0246 5.38889L11.179 1.54323C10.9403 1.30458 10.9403 0.917645 11.179 0.678991C11.4176 0.440337 11.8046 0.440337 12.0432 0.678991L16.9321 5.56788C17.1708 5.80653 17.1708 6.19347 16.9321 6.43212L12.0432 11.321C11.8046 11.5597 11.4176 11.5597 11.179 11.321C10.9403 11.0824 10.9403 10.6954 11.179 10.4568L15.0246 6.61111L0.611111 6.61111C0.273604 6.61111 0 6.33751 0 6Z"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="pills-item-ten-tab" data-bs-toggle="pill"
                                            ...
                                            aria-controls="pills-item-ten" aria-selected="false">
                                            Industrial Electronics<span class="rs-services-icon"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="18" height="12"
                                                    viewBox="0 0 18 12" fill="none">
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                                        d="M0 6C0 5.66249 0.273604 5.38889 0.611111 5.38889L15.0246 5.38889L11.179 1.54323C10.9403 1.30458 10.9403 0.917645 11.179 0.678991C11.4176 0.440337 11.8046 0.440337 12.0432 0.678991L16.9321 5.56788C17.1708 5.80653 17.1708 6.19347 16.9321 6.43212L12.0432 11.321C11.8046 11.5597 11.4176 11.5597 11.179 11.321C10.9403 11.0824 10.9403 10.6954 11.179 10.4568L15.0246 6.61111L0.611111 6.61111C0.273604 6.61111 0 6.33751 0 6Z"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="pills-item-eleven-tab" data-bs-toggle="pill"
                                            data-bs-target="#pills-item-eleven" type="button" role="tab"
                                            aria-controls="pills-item-eleven" aria-selected="false">
                                            Machine Vision<span class="rs-services-icon"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="18" height="12"
                                                    viewBox="0 0 18 12" fill="none">
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                                        d="M0 6C0 5.66249 0.273604 5.38889 0.611111 5.38889L15.0246 5.38889L11.179 1.54323C10.9403 1.30458 10.9403 0.917645 11.179 0.678991C11.4176 0.440337 11.8046 0.440337 12.0432 0.678991L16.9321 5.56788C17.1708 5.80653 17.1708 6.19347 16.9321 6.43212L12.0432 11.321C11.8046 11.5597 11.4176 11.5597 11.179 11.321C10.9403 11.0824 10.9403 10.6954 11.179 10.4568L15.0246 6.61111L0.611111 6.61111C0.273604 6.61111 0 6.33751 0 6Z"
                                ...
                                <div class="tab-content rs-services-tab-anim" id="pills-tabContent2">
                                    <div class="tab-pane fade show active" id="pills-item-four" role="tabpanel"
                                        ...
                                        <div class="rs-services-tab-content-wrapper p-relative">
                                            <div class="rs-services-tab-inner">
                                                <div class="rs-services-tab-content-thumb">
                                                    <img src="assets/images/services/services-thumb-34.png" alt="image">
                                                </div>
                                                <div class="rs-services-tab-content">
                                                    <h3 class="rs-services-tab-title">The automation industry involves
                                                        the application</h3>
                                                    <p>The industryâ€™s standard dummy text ever since the 1500s, when
                                                        an
                                                        unknown
                                                    ...
                                                    <div class="rs-services-tab-btn">
                                                        <a class="rs-btn has-text has-icon has-theme-cyan"
                                    ...
                                    <div class="tab-pane fade" id="pills-item-five" role="tabpanel"
                                        ...
                                        <div class="rs-services-tab-content-wrapper p-relative">
                                            <div class="rs-services-tab-inner">
                                                <div class="rs-services-tab-content-thumb">
                                                    <img src="assets/images/services/services-thumb-35.png" alt="image">
                                                </div>
                                                <div class="rs-services-tab-content">
                                                    <h3 class="rs-services-tab-title">Bridge construction is a
                                                        complex engineering
                                                    </h3>
                                                    <p>The industryâ€™s standard dummy text ever since the 1500s, when
                                                        an
                                    ...
                                    <div class="tab-pane fade" id="pills-item-six" role="tabpanel"
                                        ...
                                        <div class="rs-services-tab-content-wrapper p-relative">
                                            <div class="rs-services-tab-inner">
                                                <div class="rs-services-tab-content-thumb">
                                                    <img src="assets/images/services/services-thumb-36.png" alt="image">
                                                </div>
                                                <div class="rs-services-tab-content">
                                                    <h3 class="rs-services-tab-title">The oil and gas energy sector
                                                        is a crucial
                                                    </h3>
                                                    <p>The industryâ€™s standard dummy text ever since the 1500s, when
                                                        an
                                    ...
                                    <div class="tab-pane fade" id="pills-item-seven" role="tabpanel"
                                        ...
                                        <div class="rs-services-tab-content-wrapper p-relative">
                                            <div class="rs-services-tab-inner">
                                                <div class="rs-services-tab-content-thumb">
                                                    <img src="assets/images/services/services-thumb-37.png" alt="image">
                                                </div>
                                                <div class="rs-services-tab-content">
                                                    <h3 class="rs-services-tab-title">We solve worldwide industrial
                                                        every problem
                                                    </h3>
                                                    <p>The industryâ€™s standard dummy text ever since the 1500s, when
                                                        an
                                    ...
                                    <div class="tab-pane fade" id="pills-item-eight" role="tabpanel"
                                        ...
                                        <div class="rs-services-tab-content-wrapper p-relative">
                                            <div class="rs-services-tab-inner">
                                                <div class="rs-services-tab-content-thumb">
                                                    <img src="assets/images/services/services-thumb-38.png" alt="image">
                                                </div>
                                                <div class="rs-services-tab-content">
                                                    <h3 class="rs-services-tab-title">A high regulation industry
                                                        refers</h3>
                                                    <p>The industryâ€™s standard dummy text ever since the 1500s, when
                                                        an
                                                        unknown
                                    ...
                                    <div class="tab-pane fade" id="pills-item-nine" role="tabpanel"
                                        ...
                                        <div class="rs-services-tab-content-wrapper p-relative">
                                            <div class="rs-services-tab-inner">
                                                <div class="rs-services-tab-content-thumb">
                                                    <img src="assets/images/services/services-thumb-39.png" alt="image">
                                                </div>
                                                <div class="rs-services-tab-content">
                                                    <h3 class="rs-services-tab-title">Mechanical engineering is a
                                                        broad field</h3>
                                                    <p>The industryâ€™s standard dummy text ever since the 1500s, when
                                                        an
                                                        unknown
                                    ...
                                    <div class="tab-pane fade" id="pills-item-ten" role="tabpanel"
                                        ...
                                        <div class="rs-services-tab-content-wrapper p-relative">
                                            <div class="rs-services-tab-inner">
                                                <div class="rs-services-tab-content-thumb">
                                                    <img src="assets/images/services/services-thumb-40.png" alt="image">
                                                </div>
                                                <div class="rs-services-tab-content">
                                                    <h3 class="rs-services-tab-title">Mechanical engineering is a
                                                        broad field</h3>
                                    ...
                                    <div class="tab-pane fade" id="pills-item-eleven" role="tabpanel"
                                        aria-labelledby="pills-item-six-tab" tabindex="0">
                                        <div class="rs-services-tab-content-wrapper p-relative">
                                            <div class="rs-services-tab-inner">
                                                <div class="rs-services-tab-content-thumb">
                                                    <img src="assets/images/services/services-thumb-41.png" alt="image">
                                                </div>
                                                <div class="rs-services-tab-content">
                                                    <h3 class="rs-services-tab-title">Mechanical engineering is a
                                                        broad field</h3>
        ...
        <div class="rs-text-slide-area rs-text-slide-two has-theme-cyan">
            <div class="container has-large">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="rs-text-slide-wrapper">
                            <div class="gsap-marquee right speed-20 move-to-1000">
                                <div class="rs-text-slide-inner">
                                    ...
                                    <div class="rs-text-slide-item">
                                        <h2 class="rs-text-slide-title">&amp; Development Training Quality Assurance
                                        </h2>
                                    </div>
                                    <div class="rs-text-slide-item">
                                        <h2 class="rs-text-slide-title">&amp; Testing Product Design</h2>
        ...
        <!-- video area start -->
        <div class="rs-video-area rs-video-five section-space-bottom">
            <div class="container has-large">
                <div class="row">
                    <div class="col-xl-12">
        ...
        <section class="rs-work-stpe-area section-space-bottom rs-work-step-three  has-theme-cyan">
            <div class="container has-large">
                <div class="row g-5 process-counts">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                        <div class="rs-work-step-item  wow fadeIn" data-wow-delay=".5s">
                            ...
                            <p class="descrip"> Ority have suffered alteration in some randomised words which don't look
                                even
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                        <div class="rs-work-step-item  wow fadeIn" data-wow-delay=".7s">
                            ...
                            <p class="descrip">All the Lorem Ipsum generators on the Internet tend to repeat predefined
                                chunks
                                as necessary. </p>
                        </div>
                    </div>
        ...
        <section id="homeportfolio" class="rs-portfolio-area section-space-bottom rs-portfolio-five">
            <div class="container has-large">
                ...
                <div class="row  g-5 section-title-space align-items-center">
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="rs-services-btn">
                            <a class="rs-btn has-theme-cyan has-icon has-bg" href="portfolio.html">See More Works
                                <span class="icon-box">
                                    <svg class="icon-first" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                                        <path
                                            d="M31.71,15.29l-10-10L20.29,6.71,28.59,15H0v2H28.59l-8.29,8.29,1.41,1.41,10-10A1,1,0,0,0,31.71,15.29Z">
                    ...
                    <div class="col-xl-6 col-lg-12">
                        <div class="rs-portfolio-item">
                            <div class="rs-portfolio-thumb">
                                <img src="assets/images/portfolio/portfolio-thumb-49.png" alt="image">
                            </div>
                            <div class="rs-portfolio-content has-large">
                                <h3 class="rs-portfolio-title has-big underline has-white"> <a
                                        href="portfolio-details.html">Intelligent Sensors for Real-time Monitoring</a>
                                </h3>
                                <div class="rs-portfolio-tag has-theme-cyan">
                                    <a href="portfolio-details.html">Automations</a>
                                </div>
                            </div>
                            <div class="rs-services-text-btn">
                                <a class="rs-btn has-theme-cyan has-icon has-bg" href="portfolio.html">See More
                                    Works
                                    <span class="icon-box">
                                        <svg class="icon-first" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                                            <path
                    ...
                    <div class="col-xl-6 col-lg-12">
                        <div class="row g-5">
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="rs-portfolio-item">
                                    <div class="rs-portfolio-thumb">
                                        <img src="assets/images/portfolio/portfolio-thumb-50.png" alt="image">
                                    </div>
                                    <div class="rs-portfolio-content">
                                        <h5 class="rs-portfolio-title underline has-white"> <a
                                                href="portfolio-details.html">Improving Energy Efficiency in Metal
                                                Extraction</a></h5>
                                        <div class="rs-portfolio-tag has-theme-cyan">
                                            <a href="portfolio-details.html">Automation</a>
                                        </div>
                                    </div>
                                    <div class="rs-services-text-btn">
                                        <a class="rs-btn has-theme-cyan has-icon has-bg" href="portfolio.html">See
                                            More
                                            Works
                                            <span class="icon-box">
                                                <svg class="icon-first" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="rs-portfolio-item">
                                    <div class="rs-portfolio-thumb">
                                        <img src="assets/images/portfolio/portfolio-thumb-51.png" alt="image">
                                    </div>
                                    <div class="rs-portfolio-content">
                                        <h5 class="rs-portfolio-title underline has-white"> <a
                                                href="portfolio-details.html"> Technological Solutions For Factories</a>
                                        </h5>
                                        <div class="rs-portfolio-tag has-theme-cyan">
                                            <a href="portfolio-details.html">Automation</a>
                                        </div>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="rs-portfolio-item">
                                    <div class="rs-portfolio-thumb">
                                        <img src="assets/images/portfolio/portfolio-thumb-52.png" alt="image">
                                    </div>
                                    <div class="rs-portfolio-content">
                                        <h5 class="rs-portfolio-title underline has-white"> <a
                                                href="portfolio-details.html">Novel Metal Casting Techniques for Complex
                                            </a></h5>
                                        <div class="rs-portfolio-tag has-theme-cyan">
                                            <a href="portfolio-details.html">Automation</a>
                                        </div>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="rs-portfolio-item">
                                    <div class="rs-portfolio-thumb">
                                        <img src="assets/images/portfolio/portfolio-thumb-53.png" alt="image">
                                    </div>
                                    <div class="rs-portfolio-content">
                                        <h5 class="rs-portfolio-title underline has-white"> <a
                                                href="portfolio-details.html">Robotic Automation in Metal Forming</a>
                                        </h5>
                                        <div class="rs-portfolio-tag has-theme-cyan">
                                            <a href="portfolio-details.html">Automation</a>
                                        </div>
        ...
        <!-- counter area start -->
        <div class="rs-counter-area rs-counter-one section-space-bottom has-theme-blue">
            <div class="container has-large">
                <div class="row g-5">
        ...
        <section class="rs-testimonial-area section-space-bottom rs-testimonial-four rs-swiper has-theme-cyan">
            <div class="container has-large">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="rs-section-subtitle-wrapper">
                ...
                <div class="row  g-5 section-title-space align-items-center">
                    <div class="col-xl-6 col-lg-6">
                        <div class="rs-section-title-wrapper">
                            <h2 class="rs-section-title has-theme-cyan rs-split-text-enable split-in-fade">What
                                client
                                say about Western Bearning</h2>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6">
                        <div class="rs-testimonial-btn">
                            <a class="rs-btn has-theme-cyan has-icon has-bg" href="contact.html">View More Reviews
                                <span class="icon-box">
                                    <svg class="icon-first" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                                        <path
                                            d="M31.71,15.29l-10-10L20.29,6.71,28.59,15H0v2H28.59l-8.29,8.29,1.41,1.41,10-10A1,1,0,0,0,31.71,15.29Z">
        ...
        <!-- brand area start -->
        <div class="rs-brand-area section-space-bottom rs-brand-two has-theme-light-blue">
                ...
                <div class="row  g-5 section-title-space">
                    <div class="col-12">
                        <div class="rs-brand-wrapper">
                            <div class="rs-section-title-wrapper">
                                <h2
                                    class="rs-section-title has-theme-light-blue rs-split-text-enable split-in-fade mb-20">
                                    Our
        ...
        <!-- team area start -->
        <section class="rs-team-area rs-team-one has-theme-cyan">
            <div class="container has-large">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="rs-section-subtitle-wrapper">
                ...
                <div class="row  g-5 section-title-space align-items-center">
                    <div class="col-xl-6 col-lg-6">
                        <div class="rs-section-title-wrapper">
                            <h2 class="rs-section-title has-theme-light-blue rs-split-text-enable split-in-fade">The
                                best
                                industry experts</h2>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6">
                        <div class="rs-team-btn">
                            <a class="rs-btn has-theme-cyan has-icon has-bg" href="team.html">View More Member
                                <span class="icon-box">
                                    <svg class="icon-first" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                                        <path
                                            d="M31.71,15.29l-10-10L20.29,6.71,28.59,15H0v2H28.59l-8.29,8.29,1.41,1.41,10-10A1,1,0,0,0,31.71,15.29Z">
                ...
                <div class="row g-5">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="rs-team-item wow fadeInUp" data-wow-delay=".9s" data-wow-duration="1s">
                            <div class="rs-team-thumb">
                                <a href="team-details.html"><img src="assets/images/team/team-thumb-04.png"
                                        alt="image"></a>
                                <div class="rs-theme-social rs-team-social has-transparent">
                                    <a href="#"><i class="ri-twitter-x-line"></i></a>
                                    <a href="#"><i class="ri-facebook-fill"></i></a>
        ...
        <!-- blog area start -->
        <section id="homeblog" class="rs-blog-area section-space rs-blog-one has-theme-cyan">
            <div class="container has-large">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="rs-section-subtitle-wrapper">
                ...
                <div class="row  g-5 section-title-space align-items-center">
                    <div class="col-xl-6 col-lg-6">
                        <div class="rs-section-title-wrapper">
                            <h2 class="rs-section-title has-theme-cyan rs-split-text-enable split-in-fade"> Latest
                                News
                                and Blog</h2>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6">
                        <div class="rs-blog-btn">
                            <a class="rs-btn has-theme-cyan has-icon has-bg" href="blog.html">Read More Post
                                <span class="icon-box">
                                    <svg class="icon-first" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                                        <path
                                            d="M31.71,15.29l-10-10L20.29,6.71,28.59,15H0v2H28.59l-8.29,8.29,1.41,1.41,10-10A1,1,0,0,0,31.71,15.29Z">
                ...
                <div class="row g-5">
                    <div class="col-xl-6 col-lg-6">
                        <div class="rs-blog-item has-thumb-height wow fadeInLeft" data-wow-delay=".3s"
                            ...
                            <div class="has-bg rs-blog-bg-thumb" data-background="assets/images/blog/blog-thumb-22.png">
                            </div>
                            <div class="rs-blog-content has-position">
                                ...
                                <h3 class="rs-blog-title has-white has-big underline"> <a
                                        href="blog-details.html">Interactive technologies in factories and plants</a>
                                </h3>
                                <p class="rs-blog-description has-white">Industry's standard dummy text ever since the
                                    1500s,
                                    when an unknown printer took a galley of
                                    type and...</p>
                                <div class="rs-blog-tag has-white has-theme-cyan">
                        ...
                        <div class="row g-5 wow fadeInRight" data-wow-delay=".3s" data-wow-duration="1s">
                            <div class="col-12">
                                <div class="rs-blog-item has-grid">
                                    <div class="rs-blog-content has-padding order-1 order-sm-0">
                                        ...
                                        <div class="rs-blog-tag has-theme-cyan">
                                            <a href="blog-details.html">Oil Factory</a>
                                        </div>
                                    </div>
                                    <div class="rs-blog-thumb order-0 order-sm-1">
                                        <a href="blog-details.html">
                                            <img src="assets/images/blog/blog-thumb-23.png" alt="image">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="rs-blog-item has-grid">
                                    ...
                                    <div class="rs-blog-thumb order-0 order-sm-1">
                                        <a href="blog-details.html">
                                            <img src="assets/images/blog/blog-thumb-24.png" alt="image">
                                        </a>
                                    </div>
                                </div>
                            </div>
        ...
        <!-- cta area start -->
        <section id="homecontact" class="rs-cta-area rs-cta-three has-theme-cyan">
            <div class="container has-large">
                    ...
                    <div class="row align-items-center g-5">
                        <div class="col-xxl-7 col-xl-6 col-lg-6">
                            <div class="rs-cta-content">
                                ...
                                <div class="rs-section-title-wrapper">
                                    <h2 class="rs-section-title rs-split-text-enable split-in-fade">Sign up to get the
                                        latest
                                        updates</h2>
                            ...
                            <div class="rs-cta-form">
                                <form action="#">
                                    <div class="rs-cta-input">
                                        ...
                                        <button type="submit" class="rs-btn has-theme-cyan has-icon has-bg">Subscribe
                                            Now
                                            <span class="icon-box">
                                                <svg class="icon-first" xmlns="http://www.w3.org/2000/svg"
                                                    viewBox="0 0 32 32">
...
export default AutomationOnePage
