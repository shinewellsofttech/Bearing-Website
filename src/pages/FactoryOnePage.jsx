...
function FactoryOnePage() {
  ...
  const htmlContent = `
        ...
        <!-- banner area start -->
        <section id="home" class="rs-banner-area rs-banner-nine rs-swiper">
        ...
        <!-- about area start -->
        <section id="homeabout" class="rs-about-area section-space rs-about-nine">
            <div class="container">
                <div class="row g-5">
                            ...
                            <div class="rs-about-content-wrapper">
                                <div class="rs-section-title-wrapper">
                                    ...
                                    <h2 class="rs-section-title rs-split-text-enable split-in-fade">We work for you
                                        <span class="rs-theme-orange">since 1989</span> Industrial around the world</h2>
        ...
        <section id="homeservices"
            class="rs-services-area rs-services-two section-space-top primary-bg has-theme-orange rs-swiper">
        ...
        <section id="homeportfolio" class="rs-portfolio-area section-space rs-portfolio-one rs-swiper primary-bg">
            <div class="container">
        ...
        <!-- blog area start -->
        <section id="homeblog" class="rs-blog-area section-space rs-blog-two has-theme-orange has-pos-none rs-swiper">
            <div class="container">
        ...
        <!-- cta area start -->
        <section id="homecontact" class="rs-cta-area rs-cta-two has-theme-orange-two">
            <div class="container">
                <div class="rs-cta-wrapper">
