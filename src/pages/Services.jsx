...
function Services() {
  ...
  const htmlContent = `
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="rs-services-wrapper">
                            <div class="rs-services-item">
                                ...
                                <div class="rs-services-content">
                                    <h5 class="rs-services-title"><a href="services-details.html">Fuel &amp; Gas
                                            management </a></h5>
                                    <p class="descrip">Consectetur ipiscing elit tellus ullam corper mattis</p>
                                    <div class="rs-services-number"></div>
                                    <div class="rs-services-btn-wrapper">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="rs-services-wrapper">
                            <div class="rs-services-item">
                                ...
                                <div class="rs-services-content">
                                    <h5 class="rs-services-title"><a href="services-details.html"> Oil construction and
                                            gas
                                            production </a></h5>
                                    <p class="descrip">Consectetur ipiscing elit tellus ullam corper mattis</p>
                                    <div class="rs-services-number"></div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="rs-services-wrapper">
                            <div class="rs-services-item">
                                <div class="rs-services-thumb">
                                    <a href="services-details.html"> <img
                                            src="assets/images/services/services-thumb-33.png" alt="image"></a>
                                </div>
                                <div class="rs-services-content">
                                    <h5 class="rs-services-title"><a href="services-details.html"> Manufacturer of tin
                                            lead and
                                            lead</a></h5>
                                    <p class="descrip">Consectetur ipiscing elit tellus ullam corper mattis</p>
                                    <div class="rs-services-number"></div>
                ...
                <div class="row g-5">
                    <div class="col-xxl-7 col-xl-7 col-lg-7 col-md-8 col-sm-10">
                        <div class="rs-section-title-wrapper section-title-space ">
                            <span class="rs-section-subtitle has-white justify-content-start">
        ...
        <section class="rs-work-step-area section-space rs-work-step-five">
            <span class="rs-stroke-text">Work Process</span>
            <div class="rs-work-step-bg-thumb" data-background="assets/images/bg/work-process-02.png"> </div>
            <div class="container">
                <div class="row g-5">
                    <div class="col-xxl-8 col-xl-9 col-lg-9">
                        <div class="rs-section-title-wrapper section-title-space ">
                            ...
                            <h2 class="rs-section-title rs-split-text-enable split-in-fade">Project implementation
                                process</h2>
                        </div>
                    </div>
                </div>
                <div class="row g-5">
                    <div class="col-xl-7 col-lg-7">
                        <div class="rs-work-step-wrapper process-counts">
                            <div class="rs-work-step-item">
                                ...
                                <h5 class="rs-work-step-title">Design and Planning</h5>
                                <p class="descrip">Industry standard dummy text took since the when an unknown printer
                                    galley
                                    type
                                    scrambled. </p>
                            </div>
                            <div class="rs-work-step-item">
                                ...
                                <h5 class="rs-work-step-title"> Component Sourcing</h5>
                                <p class="descrip">Industry standard dummy text took since the when an unknown printer
                                    galley
                                    type
                                    scrambled. </p>
                            ...
                            <div class="rs-work-step-item">
                                ...
                                <h5 class="rs-work-step-title">Testing and Quality</h5>
                                <p class="descrip">Industry standard dummy text took since the when an unknown printer
                                    galley
                                    type
                                    scrambled. </p>
                            ...
                            <div class="rs-work-step-item">
                                ...
                                <h5 class="rs-work-step-title">Final Assembly</h5>
                                <p class="descrip">Industry standard dummy text took since the when an unknown printer
                                    galley
                                    type
                                    scrambled. </p>
        ...
        <section class="rs-pricing-area section-space rs-pricing-two">
            <div class="rs-pricing-shape">
                <img src="assets/images/shape/pricing-shape.png" alt="image">
            </div>
            <div class="container">
                <div class="row  g-5 align-items-center">
                    <div class="col-xl-7 col-lg-7">
                        <div class="rs-section-title-wrapper">
                            ...
                            <h2 class="rs-section-title">Our friendly packages</h2>
                        </div>
                    </div>
                    <div class="col-xl-5 col-lg-5">
                        <div class="rs-pricing-tab-wrapper d-flex justify-content-lg-end">
                    ...
                    <div class="row g-5">
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="rs-pricing-item">
                                <div class="rs-pricing-content">
                                    ...
                                    <div class="rs-pricing-bottom">
                                        <h2 class="rs-pricing-amount">$29.00</h2>
                                        <span class="rs-pricing-duration">Monthly</span>
                                        <p class="description">This plan includes online consultation options for all
                                            users</p>
                                    </div>
                                </div>
                                ...
                                <div class="rs-pricing-btn">
                                    <a class="rs-btn w-100 has-bg-transparent" href="contact.html">Get Start Now
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="rs-pricing-item item-active">
                                <div class="rs-pricing-bg-thumb" data-background="assets/images/bg/pricing-bg-02.png">
                                </div>
                                <span class="rs-pricing-tag">Most Popular</span>
                                <div class="rs-pricing-content">
                                    <div class="rs-pricing-top">
                                        <h4 class="rs-pricing-title">Commercial</h4>
                                        <p class="description">What you will get in this plan !!</p>
                                    </div>
                                    <div class="rs-pricing-bottom">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="rs-pricing-item">
                                <div class="rs-pricing-content">
                                    <div class="rs-pricing-top">
                                        <h4 class="rs-pricing-title">Enterprise</h4>
                                        <p class="description">What you will get in this plan !!</p>
                                    </div>
                                    <div class="rs-pricing-bottom">
                                        <h2 class="rs-pricing-amount">$89.00</h2>
                                        <span class="rs-pricing-duration">Monthly</span>
                                        <p class="description">This plan includes online consultation options for all
                                            users</p>
                                    </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="rs-pricing-item">
                                <div class="rs-pricing-content">
                                    ...
                                    <div class="rs-pricing-bottom">
                                        <h2 class="rs-pricing-amount">$49.00</h2>
                                        <span class="rs-pricing-duration">Monthly</span>
                                        <p class="description">This plan includes online consultation options for all
                                            users</p>
                                    </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="rs-pricing-item item-active">
                                ...
                                <div class="rs-pricing-content">
                                    ...
                                    <div class="rs-pricing-bottom">
                                        <h2 class="rs-pricing-amount">$69.00</h2>
                                        <span class="rs-pricing-duration">Monthly</span>
                                        <p class="description">This plan includes online consultation options for all
                                            users</p>
                                    </div>
        ...
        <!-- brand area start -->
        <section class="rs-brand-area rs-brand-one section-space primary-bg rs-swiper">
            <div class="rs-brand-bg-thumb" data-background="assets/images/bg/brand-bg-04.png"></div>
            <div class="container">
