...
function MetallurgyOnePage() {
  ...
  const htmlContent = `
        ...
        <!-- banner area start -->
        <section id="home" class="rs-banner-area rs-banner-four p-relative rs-swiper">
        ...
        <!-- about area start -->
        <section id="homeabout" class="rs-about-area section-space rs-about-four">
            <div class="container">
                <div class="row g-5">
        ...
        <!-- services area start -->
        <section id="homeservices" class="rs-servcies-area rs-services-four">
        ...
        <section id="homeportfolio" class="rs-portfolio-area rs-portfolio-three section-space-bottom">
            <div class="container">
        ...
        <!-- blog area start -->
        <section id="homeblog" class="rs-blog-area section-space rs-blog-two">
            <div class="container">
        ...
        <div class="rs-brand-thumb-wrapper">
            ...
            <!-- cta area start -->
            <section id="homecontact" class="rs-cta-area rs-cta-two">
                <div class="container">
...
export default MetallurgyOnePage
