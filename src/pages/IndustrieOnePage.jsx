...
function WesternBearningOnePage() {
  useSwiper()
  useScripts()
  ...
  const htmlContent = `
        ...
        <!-- banner area start -->
        <section id="home" class="rs-banner-area rs-banner-one p-relative rs-swiper">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="rs-banner-item-wrapper">
                                <div class="rs-banner-bg-thumb" data-background="assets/images/bg/banner-bg-01.png">
                                </div>
                                <div class="container">
                                    <div class="row">
                                        <div class="col-xxl-8 col-xl-8 col-lg-10">
                                            <div class="rs-banner-item">
                                                <div class="rs-banner-content">
                                                    <h1 class="rs-banner-title">Leader in industrial Factory around <br>
                                                        the world
                                                    </h1>
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-xxl-8 col-xl-8 col-lg-10">
                                            <div class="rs-banner-item">
                                                <div class="rs-banner-content">
                                                    <h1 class="rs-banner-title">Moving Your Industry Manufacturing <br>
                                                        Forward </h1>
                                                    <div class="rs-banner-descrip">
                                                        <p>We face each project as a new challenge and with our ability
                                                            to build and
                    ...
                    <div class="col-xl-5 col-lg-5">
                        <div class="rs-about-content">
                            <div class="rs-about-description">
                                <p class="descrip-1">Welcome to Western Bearning, a leading industry innovator with a rich
                                    history of
                                    excellence.</p>
                                <p class="descrip-2">At the heart of the global landscape, the industry stands as a
                                    multidimensional force of
                                    progress, driving economies. </p>
                            </div>
        ...
        <!-- services area start -->
        <section id="homeservices" class="rs-services-area section-space-top rs-services-one primary-bg p-relative">
                                        ...
                                        <div class="row g-5 align-items-center">
                                            ...
                                            <div class="col-xl-6 col-lg-6">
                                                <div class="rs-services-tab-content">
                                                    <h3 class="rs-services-tab-title">We solve
                                ...
                                <div class="tab-pane fade" id="pills-item-two" role="tabpanel"
                                    ...
                                    <div class="rs-services-tab-content-wrapper p-relative">
                                        <div class="row g-5 align-items-center">
                                            ...
                                            <div class="col-xl-6 col-lg-6">
                                                <div class="rs-services-tab-content">
                                                    <h3 class="rs-services-tab-title">A high regulation industry refers
                                                    </h3>
                                                    <p>The industryâ€™s standard dummy text ever since the 1500s, when an
                                                        unknown
                                                        printer took a galley. </p>
        ...
        <section id="homeportfolio" class="rs-portfolio-area section-space-top rs-portfolio-one rs-swiper">
            <div class="container">
                <div class="row  g-5 section-title-space align-items-end">
                    <div class="col-xxl-7 col-xl-8 col-lg-8">
                        <div class="rs-section-title-wrapper">
                            ...
                            <h2 class="rs-section-title">Explore Large-Scale Projects</h2>
                        </div>
                    </div>
        ...
        <!-- cta area start -->
        <div class="rs-cta-area rs-cta-one ">
            <div class="container">
                <div class="rs-cta-wrapper">
                    <div class="rs-cta-bg" data-background="assets/images/bg/cta-bg-01.png"></div>
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="rs-cta-item-wrapper">
                                <div class="rs-cta-item  wow fadeIn" data-wow-delay=".3s">
                                    <div class="rs-cta-inner">
                                        <div class="rs-cta-number-wrapper">
                                            <span class="rs-cta-number odometer" data-count="3,050">00</span>
                                        </div>
                                        <span class="rs-cta-title">Success Projects</span>
                                    </div>
                                </div>
                                <div class="rs-cta-item  wow fadeIn" data-wow-delay=".5s">
                                    <div class="rs-cta-descrip">
                                        <p>There are many variations of passages lorem ipsum available, but the majority
                                            have
                                            suffered alteration in some form. </p>
                                    </div>
                                </div>
                                <div class="rs-cta-item  wow fadeIn" data-wow-delay=".7s">
                                    <div class="rs-cta-btn">
                                        <a class="rs-btn has-theme-orange has-icon has-white has-bg"
                                            href="contact.html">Consultation
                                            &amp; Quote
                                            <span class="icon-box">
                                                <svg class="icon-first" xmlns="http://www.w3.org/2000/svg"
                                                    viewBox="0 0 32 32">
                ...
                <div class="row  g-5 justify-content-center section-title-space align-items-center">
                    <div class="col-xxl-7 col-xl-8 col-lg-8">
                        <div class="rs-section-title-wrapper text-center">
                            ...
                            <h2 class="rs-section-title rs-split-text-enable split-in-fade">The Best Industry Experts
                            </h2>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="rs-blog-item has-thumb-height wow fadeInLeft" data-wow-delay=".3s"
                            ...
                            <div class="has-bg has-clip-path rs-blog-bg-thumb"
                                data-background="assets/images/blog/blog-thumb-01.png">
                            </div>
...
export default WesternBearningOnePage
