...
function OrangeConstruction() {
  ...
  const htmlContent = `
        ...
        <section class="rs-portfolio-area section-space rs-portfolio-four rs-portfolio-tooltip rs-swiper">
            <div class="container">
        ...
        <!-- contact area start -->
        <section class="rs-contact-area rs-contact-one section-space has-theme-orange p-relative">
...
export default OrangeConstruction
