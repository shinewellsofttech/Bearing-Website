...
function YellowConstructionOnePage() {
  useSwiper()
  useScripts()
  ...
  const htmlContent = `
        ...
        <!-- banner area start -->
        <section id="home" class="rs-banner-area rs-banner-fourteen p-relative rs-swiper">
        ...
        <!-- about area start -->
        <div id="homeabout" class="rs-about-area rs-about rs-about-fifteen section-space-bottom">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
        ...
        <!-- services area start -->
        <section id="homeservices" class="rs-services-area rs-services-twelve section-space primary-bg">
            <div class="container">
        ...
        <!-- blog area start -->
        <section id="homeblog" class="rs-blog-area section-space rs-blog-two has-theme-yellow rs-swiper">
            <div class="container">
                <div class="row  g-5 section-title-space align-items-center">
                    <div class="col-xl-6 col-lg-6">
                        <div class="rs-section-title-wrapper">
        ...
        <!-- contact area start -->
        <section id="homecontact" class="rs-contact-area rs-contact-one section-space has-theme-yellow p-relative">
...
export default YellowConstructionOnePage
