...
function OrangeConstructionOnePage() {
  useSwiper()
  useScripts()
  ...
  const htmlContent = `
        ...
        <!-- banner area start -->
        <section id="home" class="rs-banner-area rs-banner-five p-relative rs-swiper">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="rs-banner-item-wrapper">
                                <div class="rs-banner-bg-thumb" data-background="assets/images/bg/banner-bg-07.png">
                                </div>
                                <div class="container">
                                    <div class="row g-5">
                                        <div class="col-xxl-6 col-xl-7 col-lg-7 col-md-9">
                                            <div class="rs-banner-item">
                                                <div class="rs-banner-content">
                                                    ...
                                                    <h1 class="rs-banner-title">Construction Building Service
                                                    </h1>
                                                    <div class="rs-banner-descrip">
                                                        <p>Our vans are fitted with high pressure jetting units which
                                                            will clear
                        ...
                        <div class="swiper-slide">
                            <div class="rs-banner-item-wrapper">
                                <div class="rs-banner-bg-thumb" data-background="assets/images/bg/banner-bg-08.png">
                                </div>
                                <div class="container">
                                    <div class="row g-5">
                                        <div class="col-xxl-6 col-xl-7 col-lg-7 col-md-9">
        ...
        <!-- feature area start -->
        <section class="rs-feature-area rs-feature-four">
            <div class="rs-feature-bg-thumb" data-background="assets/images/bg/features-bg-02.png"></div>
            <div class="container">
                <div class="row g-5">
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="rs-feature-item wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                            ...
                            <div class="rs-feature-icon">
                                <img src="assets/images/icon/feature-icon-07.png" alt="image">
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="rs-feature-item wow fadeInUp" data-wow-delay=".5s" data-wow-duration="1s">
                            ...
                            <div class="rs-feature-icon">
                                <img src="assets/images/icon/feature-icon-08.png" alt="image">
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="rs-feature-item wow fadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                            ...
                            <div class="rs-feature-icon">
                                <img src="assets/images/icon/feature-icon-09.png" alt="image">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- about area start -->
        <section id="homeabout" class="rs-about-area section-space rs-about-five">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="rs-about-wrapper">
                            <div class="rs-about-wrapper-left">
                                <div class="rs-section-title-wrapper section-title-space">
                                    ...
                                    <h2 class="rs-section-title rs-split-text-enable split-in-fade">World Leading
                                        Construction
                                        Company Since 1989.</h2>
                                </div>
                                <div class="rs-about-thumb has-large">
                                    <img src="assets/images/about/about-thumb-06.png" alt="image">
                                    <div class="rs-about-counter-wrapper gsap-move up-100 start-70">
                                        <div class="rs-counter-bg-thumb"
                                            data-background="assets/images/shape/star-shape.png">
                                        </div>
                                        ...
                                        <div class="rs-counter-item">
                                            <div class="rs-counter-inner">
                                                <div class="rs-counter-number-wrapper">
                                                    <span class="rs-counter-number odometer" data-count="35">00</span>
                            ...
                            <div class="rs-about-wrapper-right">
                                <div class="rs-about-thumb has-small">
                                    <img src="assets/images/about/about-thumb-07.png" alt="image">
                                </div>
        ...
        <!-- services area start -->
        <section id="homeservices" class="rs-services-area section-space rs-services-five primary-bg">
            <div class="container">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="rs-services-item wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                            ...
                            <div class="rs-services-content">
                                <h5 class="rs-services-title underline has-theme-orange"><a
        ...
        <section id="homeportfolio"
            class="rs-portfolio-area section-space rs-portfolio-four rs-portfolio-tooltip rs-swiper">
            <div class="container">
                                        ...
                                        <div class="rs-portfolio-thumb">
                                            ...
                                            <div class="rs-portfolio-btn-wrapper">
                                                <div class="rs-portfolio-icon-btn">
                                                    <a class="rs-square-btn has-icon has-theme-orange"
                                                ...
                                                <div class="rs-portfolio-text-btn">
                                                    <a class="rs-btn has-theme-orange"
        ...
        <section class="rs-why-choose-area section-space rs-why-choose-one primary-bg has-theme-orange">
            <div class="container">
                    ...
                    <div class="col-xl-7 col-lg-7">
                        <div class="rs-why-choose-content-wrapper">
                            <div class="rs-section-title-wrapper section-title-space">
                                ...
                                <h2 class="rs-section-title rs-split-text-enable split-in-fade">Construction
                    ...
                    <div class="col-xl-5 col-lg-5">
                        <div class="rs-why-choose-thumb-wrapper">
                            ...
                            <div class="rs-why-choose-small-thumb">
                                <img src="assets/images/why-choose/why-choose-thumb-04.png" alt="image">
                ...
                <div class="row align-items-xxl-center g-5">
                    <div class="col-xl-6 col-lg-6">
                        <div class="rs-faq-thumb  rs-image scroll_reveal reveal_left reveal-active">
                            <img decoding="async" src="assets/images/faq/faq-thumb-02.png" alt="image">
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6">
                ...
                <div class="row  g-5 justify-content-center align-items-center">
                    <div class="col-xl-6 col-lg-6">
                        <div class="rs-section-title-wrapper text-center section-title-space">
                            ...
                            <h2 class="rs-section-title rs-split-text-enable split-in-fade">Best Construction
                                Expert</h2>
                        </div>
                    </div>
                </div>
        ...
        <!-- brand area start -->
        <div class="rs-brand-area rs-brand-one section-space-bottom primary-bg rs-swiper">
            <div class="container">
                <div class="row  g-5 section-title-space justify-content-center">
                    <div class="col-xl-7 col-lg-8">
                        <div class="rs-section-title-wrapper text-center">
                            ...
                            <h2 class="rs-section-title rs-split-text-enable split-in-fade">Partners Who Trust Western Bearning
                            </h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="rs-brand-wrapper">
                        <div class="swiper" data-clone-slides="false" data-loop="true" data-speed="2000"
                            data-autoplay="true" data-dots-dynamic="false" data-hover-pause="true" data-effect="false"
                            data-delay="1000" data-item="6" data-item-xl="4" data-item-lg="4" data-item-md="3"
                            data-item-sm="2" data-item-xs="2" data-item-mobile="1" data-margin="30" data-margin-xl="30"
                            data-margin-lg="30" data-margin-md="30" data-margin-sm="30" data-margin-xs="30"
                            data-margin-mobile="30">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
        ...
        <!-- blog area start -->
        <section id="homeblog" class="rs-blog-area section-space rs-blog-one">
            <div class="container">
                <div class="row  g-5 section-title-space align-items-center">
                    <div class="col-xl-7 col-lg-7">
                        <div class="rs-section-title-wrapper">
                    ...
                    <div class="col-xl-5 col-lg-5">
                        <div class="rs-blog-btn">
                            <a class="rs-btn has-theme-orange has-icon has-bg" href="blog.html">View All Post
                                <span class="icon-box">
                                    <svg class="icon-first" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                                        <path
                                            d="M31.71,15.29l-10-10L20.29,6.71,28.59,15H0v2H28.59l-8.29,8.29,1.41,1.41,10-10A1,1,0,0,0,31.71,15.29Z">
                ...
                <div class="row g-5">
                    <div class="col-xl-6 col-lg-6">
                        <div class="rs-blog-item has-thumb-height wow fadeInLeft" data-wow-delay=".3s"
                            data-wow-duration="1s">
                            <div class="has-bg rs-blog-bg-thumb" data-background="assets/images/blog/blog-thumb-01.png">
                            </div>
        ...
        <!-- contact area start -->
        <section id="homecontact" class="rs-contact-area rs-contact-one section-space has-theme-orange p-relative">
...
export default OrangeConstructionOnePage
