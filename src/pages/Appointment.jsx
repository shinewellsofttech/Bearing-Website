...
function Appointment() {
  ...
  const htmlContent = `
        ...
        <section class="rs-work-step-area rs-work-step-one section-space has-different-style">
            <div class="container">
        ...
        <!-- contact area start -->
        <section class="rs-contact-area section-space-bottom rs-contact-three">
            <div class="container">
                <div class="row g-5">
                    <div class="col-xl-6 col-lg-6">
                        <div class="rs-contact-thumb rs-image scroll_reveal reveal_left reveal-active">
                            <img decoding="async" src="assets/images/contact/contact-thumb-01.png" alt="image">
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6">
                        <div class="rs-contact-form rs-contact-one has-black">
                            <h3 class="rs-contact-form-title mb-10">Make an appointment</h3>
