...
function Manufacturing() {
  ...
  const htmlContent = `
        ...
        <!-- about area start -->
        <section class="rs-about-area section-space-bottom rs-about-eight has-theme-green">
            <div class="container">
                <div class="row g-5">
        ...
        <!-- blog area start -->
        <section class="rs-blog-area section-space-bottom rs-blog-two has-theme-green">
            <div class="container">
