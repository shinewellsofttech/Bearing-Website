...
function Contact() {
  ...
  const htmlContent = `
        ...
        <section class="rs-breadcrumb-area rs-breadcrumb-one p-relative" style="padding: 100px 0 90px; overflow: hidden;">
            <div class="rs-breadcrumb-bg" data-background="/assets/images/Main-images/Hero/contactHero (1).jpeg" style="background-image: url('/assets/images/Main-images/Hero/contactHero (1).jpeg'); background-position: center top; background-size: cover; filter: brightness(0.65);"></div>
            <div class="container" style="position: relative; z-index: 2;">
                <div class="row align-items-center g-4">
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="rs-breadcrumb-content-wrapper">
                            <div class="rs-breadcrumb-title-wrapper">
                                <h1 class="rs-breadcrumb-title" style="color: #ffffff; font-size: 48px; font-weight: 800; text-shadow: 0 4px 16px rgba(0,0,0,0.4);">Contact Us</h1>
                            </div>
                    ...
                    <!-- Right Column: Main Offices Glass Card -->
                    <div class="col-lg-6 col-md-12">
                        <div class="rs-contact-wrapper" style="margin-top: 40px; background: rgba(255, 255, 255, 0.12); backdrop-filter: blur(18px); -webkit-backdrop-filter: blur(18px); padding: 32px 28px; border-radius: 20px; color: #ffffff; position: relative; overflow: hidden; box-shadow: 0 20px 50px rgba(0, 0, 0, 0.35); border: 1px solid rgba(255, 255, 255, 0.25);">
                            <div class="rs-contact-shape" style="opacity: 0.18; position: absolute; top: -10px; right: -10px;">
                                <svg xmlns="http://www.w3.org/2000/svg" width="110" height="110" viewBox="0 0 54 54" fill="none">
                                    <path d="M0 27C0 12.0883 12.0883 0 27 0C41.9117 0 54 12.0883 54 27V54H48V27C48 15.402 38.598 6 27 6C15.402 6 6 15.402 6 27V54H0V27Z" fill="#ffffff"></path>
                                    <path d="M27 12C18.3015 12 11.25 19.0515 11.25 27.75V54H42.75V27.75C42.75 19.0515 35.6985 12 27 12Z" fill="#ffffff"></path>
                                </svg>
                            </div>
                            <h3 class="rs-contact-title" style="color: #ffffff; font-size: 24px; font-weight: 700; margin-bottom: 4px;">Main Offices</h3>
                            <span class="rs-contact-meta" style="color: rgba(255,255,255,0.85); font-size: 13px; display: inline-block; margin-bottom: 18px;">Mon - Sat 10.00 - 18.00</span>
                            <div class="rs-contact-btn" style="margin-bottom: 22px;">
                                <a class="rs-btn has-icon w-100" href="https://maps.app.goo.gl/4CyH82tFmf6L8H1TA" style="background: #ffffff; color: #0C7BC7; font-weight: 700; padding: 10px 18px; border-radius: 10px;">View Location
                                    <span class="icon-box">
                            ...
                            <div class="rs-cotact-list-wrapper">
                                <div class="rs-contact-item" style="display: flex; align-items: center; gap: 12px; margin-bottom: 14px;">
                                    <div class="rs-contact-icon" style="width: 36px; height: 36px; border-radius: 8px; background: rgba(255,255,255,0.2); display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
