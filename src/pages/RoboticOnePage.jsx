...
function RoboticOnePage() {
  ...
  const htmlContent = `
        ...
        <!-- banner area start -->
        <section id="home" class="rs-banner-area rs-banner-ten rs-swiper">
            <div class="rs-banner-slider-wrapper">
                <div class="swiper" data-clone-slides="false" data-loop="false" data-speed="2000" data-autoplay="true"
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="rs-banner-item-wrapper">
                                <div class="rs-banner-bg-thumb" data-background="assets/images/bg/banner-bg-16.png">
                                </div>
                                <div class="container">
                                    <div class="row">
                                        <div class="col-xxl-8 col-xl-9 col-lg-10">
                                            <div class="rs-banner-item">
                                                <div class="rs-banner-content">
                                                    ...
                                                    <h1 class="rs-banner-title">The automation of our world offers
                                                        tremendous
                                                        benefits
                                                    </h1>
                                                    <div class="rs-banner-descrip">
                                                        <p>At the heart of the global landscape, standard dummy text
                                                            ever since the
                                                            1500s, when an unknown printer the industry.</p>
                                                    </div>
                                                    <div class="rs-banner-info-btn">
                                                        <div class="rs-banner-btn">
                                                            <a class="rs-btn has-theme-orange has-icon has-bg has-large-radius"
                        ...
                        <div class="swiper-slide">
                            <div class="rs-banner-item-wrapper">
                                <div class="rs-banner-bg-thumb" data-background="assets/images/bg/banner-bg-17.png">
                                </div>
                                <div class="container">
                                    <div class="row">
                                        <div class="col-xxl-8 col-xl-9 col-lg-10">
                                            <div class="rs-banner-item">
                                                <div class="rs-banner-content">
                                                    ...
                                                    <h1 class="rs-banner-title">The robotization of our world is an
                                                        great advantage
                                                    </h1>
                                                    <div class="rs-banner-descrip">
                                                        <p>At the heart of the global landscape, standard dummy text
        ...
        <!-- about area start -->
        <section id="homeabout" class="rs-about-area section-space rs-about-ten">
                            ...
                            <div class="rs-about-thumb-wrapper">
                                ...
                                <div class="rs-about-counter-wrapper">
                                    <div class="rs-counter-item">
                                        ...
                                        <span class="rs-counter-title"><span class="large-text">Highly</span>
                                            Specialised <br>
                                            Employees</span>
                                    </div>
                                </div>
        ...
        <!-- services area start -->
        <section id="homeservices" class="rs-services-area section-space rs-services-nine primary-bg rs-swiper">
            <div class="container">
                <div class="row  g-5 justify-content-center section-title-space align-items-center">
                    <div class="col-xl-9 col-lg-10">
                        <div class="rs-section-title-wrapper text-center">
                            ...
                            <h2 class="rs-section-title rs-split-text-enable split-in-fade">We Provide marvelous our
                                <span class="rs-theme-orange">Western Bearnings
                                    services</span> world's leading</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="rs-services-slider-wrapper">
                            <div class="swiper" data-clone-slides="false" data-loop="false" data-speed="2000"
                                data-autoplay="true" data-dots-dynamic="false" data-hover-pause="true"
                                data-effect="false" data-delay="1000" data-item="3" data-item-xl="2" data-item-lg="2"
                                ...
                                <div class="swiper-wrapper process-counts">
                                    <div class="swiper-slide">
                                        <div class="rs-services-item">
                                            <div class="rs-services-thumb">
                                                <img src="assets/images/services/services-thumb-24.png" alt="image">
                                            </div>
                                            <div class="rs-services-content">
                                                <h5 class="rs-services-title"><a href="services-details.html"> Robot
                                                        Installation
                                                    </a></h5>
                                                <div class="rs-services-descrip">
                                                    <p>Stands as a multidimensional force of progress driving.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="rs-services-item">
                                            <div class="rs-services-thumb">
                                                <img src="assets/images/services/services-thumb-25.png" alt="image">
                                            </div>
                                            <div class="rs-services-content">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="rs-services-item">
                                            <div class="rs-services-thumb">
                                                <img src="assets/images/services/services-thumb-26.png" alt="image">
                                            </div>
                                            <div class="rs-services-content">
                                                <h5 class="rs-services-title"><a href="services-details.html"> IOT
                                                        Integration </a>
                                                </h5>
                                                <div class="rs-services-descrip">
                                                    <p>Consectetur ipiscing elit tellus ullam corper mattis</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="rs-text-slide-area rs-text-slide-three">
                            ...
                            <div class="gsap-marquee right speed-20 move-to-1000">
                                <div class="rs-text-slide-inner">
                                    <div class="rs-text-slide-item">
                                        <h2 class="rs-text-slide-title"> Quality Assurance &amp; Testing</h2>
                                    </div>
                                    <div class="rs-text-slide-item">
                                        <h2 class="rs-text-slide-title">Product Design &amp; Development</h2>
                                    </div>
                                    <div class="rs-text-slide-item">
                                        <h2 class="rs-text-slide-title">Training &amp;</h2>
                                    </div>
                                    <div class="rs-text-slide-item">
                                        <h2 class="rs-text-slide-title">Skill Development Quality Assurance &amp;</h2>
                                    </div>
                                    <div class="rs-text-slide-item">
                                        <h2 class="rs-text-slide-title">Testing
                                            Product Design &amp;</h2>
                                    </div>
                                    <div class="rs-text-slide-item">
                                        <h2 class="rs-text-slide-title">Development
                                            Training &amp;</h2>
                                    </div>
                                    <div class="rs-text-slide-item">
                                        <h2 class="rs-text-slide-title">Skill Development</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="rs-why-choose-content-inner">
                                <div class="rs-why-choose-content-item wow fadeInUp" data-wow-delay=".3s"
                                    ...
                                    <div class="rs-why-choose-content">
                                        <h6 class="rs-why-choose-title"> We're Certified Company</h6>
                                ...
                                <div class="rs-why-choose-content-item wow fadeInUp" data-wow-delay=".5s"
                                    ...
                                    <div class="rs-why-choose-content">
                                        <h6 class="rs-why-choose-title"> We Are Bring Quality Services</h6>
                                        <p class="descrip"> Stands as a multidimensional force of progress. </p>
                                    </div>
                                </div>
        ...
        <section id="homeportfolio" class="rs-portfolio-area section-space rs-portfolio-seven rs-swiper">
                ...
                <div class="row  g-5 justify-content-center section-title-space align-items-center">
                    <div class="col-xxl-6 col-xl-7 col-lg-8 col-md-8 col-sm-10">
                        <div class="rs-section-title-wrapper text-center">
                            ...
                            <h2 class="rs-section-title rs-split-text-enable split-in-fade">Gallery our company's
                                complete
                                <span class="rs-theme-orange">worked</span>
                            </h2>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="rs-portfolio-slider-wrapper">
                            <div class="swiper" data-clone-slides="false" data-loop="true" data-speed="2000"
                                data-autoplay="true" data-dots-dynamic="false" data-hover-pause="true"
                                data-effect="false" data-delay="1000" data-item="3" data-item-xl="3" data-item-lg="3"
                                data-item-md="2" data-item-sm="1" data-item-xs="1" data-item-mobile="1"
                                data-margin="30">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="rs-portfolio-item">
                                            <div class="rs-portfolio-thumb">
                                                <img src="assets/images/portfolio/portfolio-thumb-29.png" alt="image">
                                            </div>
                                            <div class="rs-portfolio-content">
                                                <div class="rs-portfolio-tag">
                                                    <a href="portfolio-details.html">Robotic</a>
                                                </div>
                                                <h5 class="rs-portfolio-title"><a href="portfolio-details.html"> Metal
                                                        Engineering
                                                    </a></h5>
                                            </div>
                                        </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="rs-portfolio-item">
                                            <div class="rs-portfolio-thumb">
                                                <img src="assets/images/portfolio/portfolio-thumb-30.png" alt="image">
                                            </div>
                                            <div class="rs-portfolio-content">
                                                <div class="rs-portfolio-tag">
                                                    <a href="portfolio-details.html">Robotic</a>
                                                </div>
                                                <h5 class="rs-portfolio-title"><a href="portfolio-details.html"> Factory
                                                        Conveyors
                                                    </a></h5>
                                            </div>
                                        </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="rs-portfolio-item">
                                            <div class="rs-portfolio-thumb">
                                                <img src="assets/images/portfolio/portfolio-thumb-31.png" alt="image">
                                            </div>
                                            <div class="rs-portfolio-content">
                                                <div class="rs-portfolio-tag">
                                                    <a href="portfolio-details.html">Robotic</a>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="rs-portfolio-item">
                                            <div class="rs-portfolio-thumb">
                                                <img src="assets/images/portfolio/portfolio-thumb-28.png" alt="image">
                                            </div>
                                            <div class="rs-portfolio-content">
                                                <div class="rs-portfolio-tag">
                                                    <a href="portfolio-details.html">Robotic</a>
        ...
        <!-- team area start -->
        <section class="rs-team-area section-space rs-team-two primary-bg">
            <div class="container">
                <div class="row  g-5 justify-content-center section-title-space align-items-center">
                    <div class="col-xxl-8 col-xl-10 col-lg-10">
                        <div class="rs-section-title-wrapper text-center">
                            ...
                            <h2 class="rs-section-title rs-split-text-enable split-in-fade">We will serve you with the
                                best of
                                our capacity by <span class="rs-theme-orange">expert team</span></h2>
                        </div>
                    </div>
                </div>
                <div class="row g-5">
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        <div class="rs-team-item wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                            ...
                            <div class="rs-team-content">
                                <div class="rs-team-inner">
                                    <h5 class="rs-team-title"><a href="team-details.html">Peter Hase</a></h5>
                                    <span class="rs-team-designation">Co of Western Bearning</span>
                        ...
                        <div class="rs-team-item wow fadeInUp" data-wow-delay=".5s" data-wow-duration="1s">
                            ...
                            <div class="rs-team-content">
                                <div class="rs-team-inner">
                                    ...
                                    <span class="rs-team-designation">Head of Production</span>
                                    <div class="rs-theme-social has-transparent has-orange">
                                        <a href="#"><i class="ri-twitter-x-line"></i></a>
                                        <a href="#"><i class="ri-facebook-fill"></i></a>
                                        <a href="#"><i class="ri-linkedin-fill"></i></a>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        <div class="rs-team-item wow fadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                            ...
                            <div class="rs-team-content">
                                <div class="rs-team-inner">
                                    <h5 class="rs-team-title"><a href="team-details.html">Penelopa Miller</a></h5>
        ...
        <section class="rs-work-process-area section-space rs-work-step-two has-theme-orange">
            <div class="rs-work-step-shape gsap-move right-110 start-71">
                <img src="assets/images/shape/robo-arm-02.png" alt="image">
            </div>
            <div class="rs-work-step-bg-thumb" data-background="assets/images/bg/contact-bg-06.png"></div>
            <div class="container">
                <div class="row align-items-center g-5">
                    <div class="col-xl-7 col-lg-7">
                        <div class="rs-work-process-content-wrapper">
                            <div class="rs-section-title-wrapper section-title-space">
                                ...
                                <h2 class="rs-section-title rs-split-text-enable split-in-fade">How we <span
                                        class="rs-theme-orange">complete</span> work</h2>
                            </div>
                    ...
                    <div class="col-xl-5 col-lg-5">
                        <div class="rs-contact-form rs-contact-one has-robotic wow fadeInRight" data-wow-delay=".3s"
                            data-wow-duration="1s">
                            <div class="rs-contact-bg-thumb" data-background="assets/images/bg/contact-bg-07.png">
                            </div>
                            <h3 class="rs-contact-form-title mb-10">Have any Question?</h3>
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-12">
                                        <div class="rs-contact-btn">
                                            <button type="submit" class="rs-btn white-bg">Send Message</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
        ...
        <!-- blog area start -->
        <section id="homeblog" class="rs-blog-area section-space rs-blog-four">
            <div class="rs-blog-bg-thumb" data-background="assets/images/bg/blog-bg-01.png"></div>
            <div class="container">
                <div class="row  g-5 justify-content-center section-title-space align-items-center">
                    <div class="col-xl-8 col-lg-9 col-md-10">
                        <div class="rs-section-title-wrapper text-center">
                            ...
                            <h2 class="rs-section-title rs-split-text-enable split-in-fade">Discover the future of
                                factories
                                and <span class="rs-theme-orange">Western Bearnings</span></h2>
                        </div>
                    </div>
                </div>
                <div class="row g-5">
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="rs-blog-item wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                            <div class="rs-blog-thumb">
                                <img src="assets/images/blog/blog-thumb-16.png" alt="image">
                                <div class="rs-blog-tag">
                                    <a href="blog-details.html">Robotics</a>
                                </div>
                            </div>
                            <div class="rs-blog-content">
                                <div class="rs-blog-inner">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="rs-blog-item wow fadeInUp" data-wow-delay=".5s" data-wow-duration="1s">
                            <div class="rs-blog-thumb">
                                <img src="assets/images/blog/blog-thumb-17.png" alt="image">
                                <div class="rs-blog-tag">
                                    <a href="blog-details.html">Robotics</a>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="rs-blog-item wow fadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                            <div class="rs-blog-thumb">
                                <img src="assets/images/blog/blog-thumb-18.png" alt="image">
                                <div class="rs-blog-tag">
                                    <a href="blog-details.html">Robotics</a>
                                </div>
                            </div>
                            <div class="rs-blog-content">
                                <div class="rs-blog-inner">
                                    <h5 class="rs-blog-title underline has-black"> <a href="blog-details.html">Building
                                            resilient
                                            supply for Western Bearnings and factorie</a></h5>
                                    <div class="rs-blog-meta">
                                        <div class="rs-blog-meta-item">
                                            <span>
                                                By
        ...
        <!-- brand area start -->
        <div class="rs-brand-area rs-brand-five section-space-bottom rs-swiper">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
        ...
        <!-- cta area start -->
        <section id="homecontact" class="rs-cta-area rs-cta-two has-theme-orange">
            <div class="container">
                <div class="rs-cta-wrapper">
                    <div class="rs-cta-bg-thumb" data-background="assets/images/bg/cta-bg-06.png"></div>
                    <div class="row align-items-center">
                        <div class="col-xl-5 col-lg-5">
                            <div class="rs-cta-thumb gsap-move right-51 start-71">
                                <img src="assets/images/cta/cta-thumb-03.png" alt="image">
                            </div>
                        </div>
                        <div class="col-xl-7 col-lg-7">
