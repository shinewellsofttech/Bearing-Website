...
function RenewableEnergyOnePage() {
  useSwiper()
  useScripts()
  ...
  const htmlContent = `
        ...
        <!-- banner area start -->
        <section id="home" class="rs-banner-area rs-banner-seven">
        ...
        <!-- about area start -->
        <section id="homeabout" class="rs-about-area section-space-bottom rs-about-seven">
            <div class="container">
        ...
        <!-- services area start -->
        <section id="homeservices" class="rs-srvices-area rs-services-seven section-space-top has-space">
        ...
        <section id="homeportfolio" class="rs-why-choote-area section-space-top  rs-why-choose-two">
            <div class="container">
                <div class="row g-5">
                    <div class="col-xl-6 col-lg-6">
        ...
        <!-- blog area start -->
        <section id="homeblog" class="rs-blog-area section-space rs-blog-three primary-bg">
            <div class="container">
                <div class="row g-5">
                    <div class="row align-items-center g-5 section-title-space">
                        <div class="col-xl-7 col-lg-7">
...
export default RenewableEnergyOnePage
